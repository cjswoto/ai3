    ...
    with sr.Microphone() as source:
        while True:
            ...
            if mode == "sleeping":
                ...
                speak("Currently sleeping. Say 'AI3' to wake up.")
                ...
                speak("Listening Mode: Speak your input")
                ...
                if "ai3 command" in command.lower():
                    ...
                    speak("Command Mode: Speak 'Submit', 'Exit', or 'Close'")
...
def main():
    global prompt_entry, status_label, model_var, response_display
