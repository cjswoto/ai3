...
def main():
    ...
    listening_thread = threading.Thread(
        target=lambda: voice_control(
            lambda message: update_status_message(message, status_label, log_display),
            window,
            ...
            voice_var,
            model_var,
            voice_menu,  # Include the voice_menu in the lambda function
            log_display  # Pass the log_display widget as an argument
        ),
        daemon=True
    )
